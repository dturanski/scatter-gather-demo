...
import com.example.dashboard.web.DashboardAggregator;
...
public class IntegrationConfig {
	...
	@Bean
	public RecipientListRouter restServicesRouter() {
	...
	public MessageHandler offersHandler() {
		...
		return new RestRequestHandler("http://localhost:8081/offers", HttpMethod.GET, aggregatorInput(),OfferList
			.class);
	}
	...
	public DashboardAggregator dashboardAggregator() {
